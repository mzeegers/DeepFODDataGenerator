...
flsin = []
flstg = []
flsinFolders = sorted(os.listdir(FullDataPath))[66:112]  #Testing CT scans
flstgFolders = sorted(os.listdir(FullGTPath))[66:112]
...
NumObjsMix = [1,2,3,4,5,7,10,20,30,40]
Runs = [0,1,2,3,4]
...
np.savetxt(curPath + '/RawResults_Paper_MSD_AvgClassAcc.csv', SegAcc, delimiter=' ', fmt='%f')
np.savetxt(curPath + '/RawResults_Paper_MSD_F1ScoreAcc.csv', F1ScoreAcc, delimiter=' ', fmt='%f')
np.savetxt(curPath + '/RawResults_Paper_MSD_DetAcc.csv', Specialmetric, delimiter=' ', fmt='%f')
np.savetxt(curPath + '/RawResults_Paper_MSD_FPrate.csv', FPmetric, delimiter=' ', fmt='%f')
np.savetxt(curPath + '/RawResults_Paper_MSD_ManyFO_AvgClassAcc.csv', SegAccManyFO, delimiter=' ', fmt='%f')
np.savetxt(curPath + '/RawResults_Paper_MSD_ManyFO_F1ScoreAcc.csv', F1ScoreAccManyFO, delimiter=' ', fmt='%f')
np.savetxt(curPath + '/RawResults_Paper_MSD_ManyFO_DetAcc.csv', SpecialmetricManyFO, delimiter=' ', fmt='%f')
np.savetxt(curPath + '/RawResults_Paper_MSD_ManyFO_FPrate.csv', FPmetricManyFO, delimiter=' ', fmt='%f')
np.savetxt(curPath + '/RawResults_Paper_MSD_Mixed_AvgClassAcc.csv', SegAccMix, delimiter=' ', fmt='%f')
np.savetxt(curPath + '/RawResults_Paper_MSD_Mixed_F1ScoreAcc.csv', F1ScoreAccMix, delimiter=' ', fmt='%f')
np.savetxt(curPath + '/RawResults_Paper_MSD_Mixed_DetAcc.csv', SpecialmetricMix, delimiter=' ', fmt='%f')
np.savetxt(curPath + '/RawResults_Paper_MSD_Mixed_FPrate.csv', FPmetricMix, delimiter=' ', fmt='%f')
np.savetxt(curPath + '/RawResults_Paper_MSD_OneProj_AvgClassAcc.csv', SegAccOneProj, delimiter=' ', fmt='%f')
np.savetxt(curPath + '/RawResults_Paper_MSD_OneProj_F1ScoreAcc.csv', F1ScoreAccOneProj, delimiter=' ', fmt='%f')
np.savetxt(curPath + '/RawResults_Paper_MSD_OneProj_DetAcc.csv', SpecialmetricOneProj, delimiter=' ', fmt='%f')
np.savetxt(curPath + '/RawResults_Paper_MSD_OneProj_FPrate.csv', FPmetricOneProj, delimiter=' ', fmt='%f')
