...
# This script carries out the UNet network training using the workflow-generated (experimental) training data with 'mixed' foreign objects (1-3 or 5-8) per object
...
with open('TrainSettingsFolderNumObj' + str(NumObj) + 'Run' + str(Run) +'.txt', 'r') as f:
    ...
    for line in f:
        ...
        if cnt%2 == 0:           
            ...
            flsinFolders = flsinFolders + [flsinFoldersPossible2[number]]
            flstgFolders = flstgFolders + [flstgFoldersPossible2[number]]
        cnt += 1
print(flsinFolders)
