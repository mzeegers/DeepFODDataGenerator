...
# This script carries out the MSD network training using the workflow-generated (numerical) training data
...
# If not done beforehand, run the PhantomGeneratorTrainandTest, PhantomProjectorTrainandTest and SpectralDataGenerator scripts first (located in the scripts/numerical/generation folder) to create it
